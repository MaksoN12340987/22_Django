...
class Posts(models.Model):
    ...
    preview = models.ImageField(upload_to="photos/", verbose_name="Фотография", null=True)
    ...
    number_views = models.IntegerField(
        help_text="Количество просмотров", verbose_name="Количество просмотров", blank=True
    )
